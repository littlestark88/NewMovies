...
import id.co.example.mymovie.data.core.helper.Constant.BASE_URL
import id.co.example.mymovie.data.source.local.LocalDataSource
import id.co.example.mymovie.data.source.local.MovieDatabase
import id.co.example.mymovie.data.source.remote.MovieNowPlayingRepository
import id.co.example.mymovie.data.source.remote.RemoteDataSource
...
//    factory { AppExecutors() }
    single<IMovieNowPlayingRepository> { MovieNowPlayingRepository(get(),get()) }
}